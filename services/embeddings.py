...
def init_chroma_db(persist_directory: str = "./chroma_db") -> tuple:
    ...
    chroma_db_client = Client(Settings(persist_directory=persist_directory, anonymized_telemetry=False))
...
def add_doi_embeddings(doi: str, embeddings_model: SentenceTransformer, collection):
    """
